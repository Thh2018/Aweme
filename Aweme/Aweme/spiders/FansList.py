...
from querydata import QueryMaxTime
...
class AwemeInfoSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for fan_list in fans_lists:
            ...
            print(item)
            yield item
        if int(item['max_time']) > self.max_time:
            while has_more:
